...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/plugins/slider/css/style.css" />
    ...
    <script defer src="<?php echo get_stylesheet_directory_uri(); ?>/plugins/easing.js"></script>
    <script defer src="<?php echo get_stylesheet_directory_uri(); ?>/plugins/scrollTo.js"></script>
    <script defer src="<?php echo get_stylesheet_directory_uri(); ?>/js/main.js"></script>
	<script defer src="<?php echo get_stylesheet_directory_uri(); ?>/plugins/slider/jquery.aw-showcase.min.js"></script>
    <script defer src="<?php echo get_stylesheet_directory_uri(); ?>/plugins/jquery.vticker.js"></script>
        ...
        <div class="grid_24">
            ...
            <div class="container">
                ...
                <a id="logo" href="<?php echo home_url(); ?>/">
                    <img src="<?php echo get_header_image(); ?>" width="<?php echo HEADER_IMAGE_WIDTH; ?>"
                         height="<?php echo HEADER_IMAGE_HEIGHT; ?>" alt="<?php bloginfo('name'); ?>">
                </a>
