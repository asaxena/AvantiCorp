  ...
  <li <?php comment_class(); ?>>
    ...
    <article id="comment-<?php comment_ID(); ?>">
        ...
        <header class="comment-author vcard">
          ...
          <span><?php echo get_avatar($comment,$size='32'); ?></span>
          <span><section class="comment">
            <?php comment_text() ?>
                </section>
          </span>

        <div class="comment-text" >
        <span style="float:left;"><?php printf(__('<span class="fn">%s</span>', 'roots'), get_comment_author_link()) ?></span>
        <span style="float:right;">
        <time datetime="<?php echo comment_date('c') ?>"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"></a><?php printf(__('%1$s', 'roots'), get_comment_date(),  get_comment_time()) ?></time></span>
